...
import com.studies.springbootcourse.entities.Payment;
...
import com.studies.springbootcourse.repositories.CategoryRepository;
import com.studies.springbootcourse.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2019-07-22T15:24:22Z"), o1);
		o1.setPayment(pay1);
